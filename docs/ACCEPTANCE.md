...
Repository creation, commits, pushes, hosted CI, package publishing, GitHub
releases and registry registration have not been performed. The repository's
explicit-action requirements still apply. `RELEASE.md` defines the concrete
