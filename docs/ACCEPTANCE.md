...
The first hosted CI run is recorded in `NATIVE-CI.md`; its cache-setup and macOS
Pint failures prevent full acceptance. Package publishing, GitHub releases and registry
